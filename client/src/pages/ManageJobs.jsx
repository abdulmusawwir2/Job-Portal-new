...
const ManageJobs = () => {
  ...
  return jobs ? jobs.length === 0 ? (
    ...
    <p className="text-xl sm:text-2xl">No Jobs Available or  Posted
    </p>
  </div>) :(
    <div className="container p-4 max-w-5xl mx-auto">
      ...
      <div className="mt-4 flex justify-end ">
        <button onClick={()=>navigate('/dashboard/add-job')} className="bg-black text-white py-2 px-2 rounded">Add New Job</button>
      </div>
    </div>
  ):<Loading/>
};
